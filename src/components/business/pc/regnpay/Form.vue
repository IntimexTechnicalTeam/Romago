...
export default class Form extends Vue {
        ...
        getForm () {
          this.$Api.regAndPay.genForm(this.$route.params.id, this.currentlang, this.IsMobile).then(result => {
            this.content = result.ReturnValue.HtmlString;
            this.IsPay = result.ReturnValue.IsPay;
            this.IsLogin = result.ReturnValue.IsLogin;
