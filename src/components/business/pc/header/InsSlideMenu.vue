<template>
  <div>
      <div class="drawer-bg" :style="{backgroundColor: $Settings.PCslideMenu.maskBg, Opacity: $Settings.PCslideMenu.maskOpacity}" v-show="showMenu" @click="handleClickOutside"/>
