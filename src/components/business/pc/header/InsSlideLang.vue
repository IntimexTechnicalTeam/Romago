<template>
  <div>
      <div class="drawer-bg" :style="{backgroundColor: $Settings.PCslideMenu.maskBg, Opacity: $Settings.PCslideMenu.maskOpacity}" v-show="LangSwitch" @click="handleClickOutside"/>
...
@Component({
  components: {
    InsLangSwitch: () => import('@/components/business/pc/header/InsLangSwitch.vue')
  }
})
