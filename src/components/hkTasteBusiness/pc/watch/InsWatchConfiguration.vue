<template>
  <div class="PcWatchConfiguration" id="RomagoBg">
    ...
    <div class="topA" v-show="IsDial">
        <div class="swiper-father">
            ...
            <div class="swiper-button-prev pra" slot="button-prev"></div>
            <div class="swiper-button-next pla" slot="button-next"></div>
    ...
    <div class="topA" v-show="IsStrap">
        <div class="swiper-father">
            ...
            <div class="swiper-button-prev prb" slot="button-prev"></div>
            <div class="swiper-button-next plb" slot="button-next"></div>
    ...
    <div class="topA" v-show="IsBeltWatch">
        <div class="swiper-father" style="height:835px;" id="print" ref="print">
    ...
    .SelectVet{
      ...
      .selectAct{
        .to_right{
         width: 250px;
          ...
          cursor: pointer;
          i{
            background: url('/images/pc/to_right.png') no-repeat center center;
            width: 16px;
            height: 16px;
      ...
      .Reset{
        ...
        .resetBtn{
          ...
          cursor: pointer;
          i{
            background: url('/images/pc/reset.png') no-repeat center center;
            width: 20px;
            height: 20px;
        ...
        .to_left{
          ...
          cursor: pointer;
          i{
            background: url('/images/pc/to_left.png') no-repeat center center;
            width: 16px;
            height: 16px;
            background-size: 16px;
            display: inline-block;
